...
const SignUpOtp = ({ navigation ,route}) => {
    const { name,email,phone,password,country} = route.params;
    ...
    const handleSignUp= async () => {
        try {
            ...
            console.log("tes")
            console.log(country)
            const user = await User.register(name,phone,email,country,password,value)
            // Do something with the user object, e.g., navigate to another screen, save user data, etc.
            if(user){
                Alert.alert('Yeah..!' , 'SignUp Successfull')
                navigation.dispatch(
                    CommonActions.reset({
                        index: 0,
                        routes: [
                ...
                >
                    ...
                    contentContainerStyle={{
                            ...
                            onPress={async () => {
                                ...
                                // const user = await User.sendOtp(country["callingCode"] + phone,email)
